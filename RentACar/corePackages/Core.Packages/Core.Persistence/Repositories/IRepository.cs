...
public interface IRepository<TEntity, TEntityId> : IQuery<TEntity> where TEntity : Entity<TEntityId>
{
    ...
    Paginate<TEntity> GetListDynamic( //Filtreleme işlemi gibi,seçili filtrelere dinamik sorgular için kullanılır
    ...
    TEntity Delete(TEntity entity, bool hardDelete = false); // Kalıcı silme false tanımlandı
